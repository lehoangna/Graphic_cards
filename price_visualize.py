...
price_df['price'] = price_df['price'].str.replace('Out of stock OR See price in cart', '0')
...
price_by_brand['price'] = price_by_brand['price'].str.replace('Out of stock OR See price in cart', '0')
